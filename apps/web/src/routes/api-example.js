        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              {helloQuery.data && (<div className="rounded-md bg-muted p-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Button onClick={handleHealthRefetch} disabled={isLoading} variant="secondary">
                {healthQuery.isFetching ? "Loading..." : "Check Health"}
              </Button>
              {healthQuery.data && (<div className="rounded-md bg-muted p-4">
