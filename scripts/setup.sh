...
echo ""
echo "Next steps:"
echo "  1. Copy your Convex deployment URL to apps/web/.env"
echo "     Get it from: https://dashboard.convex.dev → Your project → Settings → URL"
echo "     Add: VITE_CONVEX_URL=https://your-project-123.convex.cloud"
echo ""
echo "  2. Link your remote repository:"
echo "     git remote add origin <your-repo-url>"
echo ""
